 ...
 *
 */
public class DiaxeirisiXartofilakiou {

	EntityManager em;
	
	public DiaxeirisiXartofilakiou() {
		em = JPAUtil.getCurrentEntityManager();
	}
	
	public Synallagi createSynallagi(String eidos, string metoxh, int temaxia, float timi, date date ) {
